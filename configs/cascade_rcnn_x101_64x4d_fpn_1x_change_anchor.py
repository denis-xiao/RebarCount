...
model = dict(
    ...
    rpn_head=dict(
        ...
        in_channels=256,
        feat_channels=256,
        anchor_scales=[5],  # image size is: 1333 x 1000
        anchor_ratios=[0.45, 0.8, 1.0, 1.25, 2.0],
        anchor_strides=[4, 8, 16, 32, 64],
        anchor_base_sizes = [5, 8, 15, 20, 25],
...
test_cfg = dict(
    ...
    # soft-nms is also supported for rcnn testing
        ...
        # e.g., nms=dict(type='nms', iou_thr=0.5)
# dataset settings
